...
import { Provider as PaperProvider, MD3LightTheme as DefaultTheme, FAB, Portal, Dialog, IconButton, MD3Colors, ActivityIndicator, MD2Colors } from 'react-native-paper';
...
"backdrop": "rgba(41, 50, 52, 0.4)"
  ...
  return (
    ...
    <ActivityIndicator style={styles.container} size={200} animating={true} color={'lightblue'} />
     </View>
      </SafeAreaProvider>
    </PaperProvider>
  );
